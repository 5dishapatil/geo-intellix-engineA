...
> **Note:** If you are on Linux, skip to Step 2.
...
2.  Copy and paste the following block to configure 8GB RAM + 20GB Disk Swap:
...
bash
git lfs install
git clone [https://huggingface.co/MBZUAI/geochat-7B](https://huggingface.co/MBZUAI/geochat-7B)

Verification: Ensure you see a folder named geochat-7B containing .bin files inside your directory.
